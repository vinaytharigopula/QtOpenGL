...
void MyWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyWorker::*)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWorker::sendPos)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyWorker::sendPos(QPointF _t1)
{
